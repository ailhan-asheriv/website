...
export default function PrivacyPage() {
  return (
    <>
      <Navigation />
      <main className="pt-32 pb-12 min-h-screen bg-dark">
          ...
          <div className="max-w-4xl">
            ...
            <div className="prose max-w-none space-y-6">
              ...
              <section className="space-y-4">
                ...
                <div className="bg-dark-lighter p-4 border border-dark-lighter my-4">
                  <p className="text-gray-light leading-relaxed">
                    <strong>Email:</strong>{" "}
                    <a
              ...
              <section className="space-y-4">
                ...
                <ul className="list-disc list-inside space-y-2 text-gray-light leading-relaxed ml-4">
                  <li>Name</li>
                  <li>Email address</li>
                  <li>Company name</li>
              ...
              <section className="space-y-4">
                ...
                <ul className="list-disc list-inside space-y-2 text-gray-light leading-relaxed ml-4 mt-4">
                  <li>
