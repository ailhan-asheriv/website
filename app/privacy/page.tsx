        ...
        <div className="container-width section-padding">
          <div className="max-w-4xl">
            ...
            <div className="prose max-w-none space-y-6">
              <p className="text-sm text-maritime/60 mb-8">
                Last updated: {new Date().toLocaleDateString("en-GB", { year: "numeric", month: "long", day: "numeric" })}
              </p>

              <section className="space-y-4">
                <h2 className="text-2xl font-serif font-semibold text-maritime mt-8 mb-4">
                  1. Introduction
                </h2>
              ...
              <section className="space-y-4">
                ...
                <div className="bg-cream-light p-4 border border-steel/20 my-4">
                  <p className="text-maritime/80 leading-relaxed">
                    <strong>Email:</strong>{" "}
                    <a
              ...
              <section className="space-y-4">
                ...
                <ul className="list-disc list-inside space-y-2 text-maritime/80 leading-relaxed ml-4">
                  <li>Name</li>
                  <li>Email address</li>
                  <li>Company name</li>
                ...
                <p className="text-maritime/80 leading-relaxed mt-4">
              ...
              <section className="space-y-4">
                ...
                <ul className="list-disc list-inside space-y-2 text-maritime/80 leading-relaxed ml-4 mt-4">
                  <li>
